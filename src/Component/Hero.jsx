    ...
    return (
        ...
        <header className='w-full h-full flex items-center justify-center text-white my-4 md:my-10'>
            ...
            >
                <img
                    alt=""
                    class=" w-full h-full md:w-[70%] xl:h-1/2 overflow-hidden md:rounded-2xl transition duration-300 ease-in-out"
                    src="https://www.isixsigma.com/wp-content/uploads/2018/11/shutterstock_1687550977-scaled.jpg"
                />
                <ScrollAnimation animateIn='fadeIn'
                    animateOut='fadeOut'>
                    <div
                        class="z-50 cursor-pointer overflow-hidden w-full h-80 absolute top-0 left-0 right-0 bottom-0 md:w-[70%] md:h-full md:left-1/2 md:-translate-x-1/2 xl:left-1/2 xl:-translate-x-1/2 from-rose-500 to-transparent bg-gradient-to-t text-white flex items-center justify-center rounded-2xl"
                    >
                        <div>
                            <div
                                class="p-4 lg:pt-32 text-center transform transition duration-300 ease-in-out flex flex-col items-center justify-center"
                            >
